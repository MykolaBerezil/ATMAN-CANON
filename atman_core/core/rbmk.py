...
class RBMKFramework:
    ...
    def __init__(self, max_recursion_depth: int = 5, uncertainty_threshold: float = 0.1):
        ...
        self.invariant_detector = RBMKInvariantDetector()
...
# Create alias for backward compatibility and expected naming
RBMKReasoner = RBMKFramework
